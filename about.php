    ...
    <h2>About This Site and My Web Development</h2>
        ...
        <div class="centerfloat redgreytear">
			<h3>My Core Skills for Website Design and Development</h3>
			  ...
			  <p>Fully customized secure e-Commerce</p>
			  <p>SSL, Stripe, Paypal</p>
			  <p>Wordpress, SmugMug, Git, Bootstrap and other frameworks</p>
        </div>
		<p>I will be adding login and upload pages in the near future to make it easy for me to build similar great sites quickly for other photographers. I will host those sites
		after creating a unique look and feel with similar structure to my own site, but tailored to your products, personality, and photography. I do everything behind the scenes, and all 
		a client needs to do is take photos, give them names, and upload them onto my shared server.</p>
